...
func enterState(prevState: String):
	...
	Utils.tryConnect(entity, "letterTyped", entity.shooter.fsm, "onSceneLetterTyped")
	Utils.tryConnect(entity, "fireCodeTyped", entity.shooter.fsm, "onSceneFireCodeTyped")
